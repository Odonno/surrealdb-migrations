...
#[tokio::test]
#[serial]
async fn apply_initial_schema_changes() {
...
#[tokio::test]
#[serial]
async fn cannot_apply_if_surreal_instance_not_running() {
    helpers::clear_files_dir();
...
#[tokio::test]
#[serial]
async fn apply_new_schema_changes() {
    helpers::clear_files_dir();
...
#[tokio::test]
#[serial]
async fn apply_initial_migrations() {
    helpers::clear_files_dir();
...
#[tokio::test]
#[serial]
async fn apply_with_db_configuration() {
    helpers::clear_files_dir();
