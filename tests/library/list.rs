...
async fn list_blog_migrations() -> Result<()> {
    ...
    let first_migration = migrations_applied
        ...
        first_migration.script_name == format!("{date_prefix}01_AddAdminUser"),
    ...
    let second_migration = migrations_applied
        ...
        second_migration.script_name == format!("{date_prefix}02_AddPost"),
    ...
    let third_migration = migrations_applied
        ...
        third_migration.script_name == format!("{date_prefix}03_CommentPost"),
