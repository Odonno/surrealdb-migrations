...
// pub async fn run_with_surreal_instance<F>(function: F) -> Result<()>
// where
//     F: FnOnce() -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<()>> + Send>>,
// {
//     run_with_surreal_instance_with_params(function, "root", "root").await
// }

// pub async fn run_with_surreal_instance_with_admin_user<F>(function: F) -> Result<()>
// where
//     F: FnOnce() -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<()>> + Send>>,
// {
//     run_with_surreal_instance_with_params(function, "admin", "admin").await
// }

// async fn run_with_surreal_instance_with_params<F>(
//     function: F,
//     username: &str,
//     password: &str,
// ) -> Result<()>
